  ...
  # Version    : 1.0
  # Details    :
  # Implements 2 interrupts triggered by button push
  # each increases/decreases and displays counter value
  */
...
void setup(){
  ...
  attachInterrupt(digitalPinToInterrupt(B2_PIN), decreaseCounter, FALLING);
...
//functions performed on interrupt
...
// decreases counter and writes value to 7-segment display
